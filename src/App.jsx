...
function Home(){
  return(
    <div>
      <Header/>
      <Buttons/>
      <Post type = "General" hcolor = "#597567" idnum={1} postText = {"Currently this page (Home) is most fully implemented. The NavBar links to pages that are not yet constructed, but routed nonetheless. The footer, links to slightly more constructed pages."+
      ...
      <Post type = "Missed Connections" hcolor = "#725975" idnum={6} postText="I was the girl in the blue shirt you talked with at Backlot around 2 the other day. I only thought to ask for your number after, so I'm hoping you see this now (:"/>
      <Footer/>
    </div>
  )
}
...
function About(){
  ...
  <div>
    <Header/>
    <Post type = "General" hcolor = "purple" user = "Hayley" postText={"Hello and welcome to the Wildcat Bulletin! The goal of this site is to act as a digital version of the " +
                                                                        "bulletins found in our lovely dining halls, that keep students informed of current events and issues and " +
                                                                        "allow them to talk about it. Posts are color coded based on their type (ex: General posts are green, Study "+
                                                                        "Help posts are yellow) to make it easier for users to find the type of post they're looking for"}/>
    <Footer/>
  </div>
  )
}
